...
* The original package name 'com.harshal.springboot.web.spring-boot-first-web-application' is invalid and this project uses 'com.harshal.springboot.web.springbootfirstwebapplication' instead.
